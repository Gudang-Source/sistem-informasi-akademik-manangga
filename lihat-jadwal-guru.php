...
// TEMPLATE CONTROL
$ui_register_page = 'lihat-jadwal-guru';

// LOAD HEADER
loadAssetsHead('Lihat Jadwal Guru');
    ...
    <div class="uk-grid uk-margin-large-top" data-uk-grid-margin data-uk-grid-match>
      ...
      <div class="uk-width-medium-5-6 tm-article-side">
        <article class="uk-article">		
          ...
          <h1 class="uk-article-title">Lihat Jadwal Guru <span class="uk-text-large">
				...
				<div id="tablewrapper">
					...
					<table id="table" class="uk-table uk-table-hover uk-table-striped uk-table-condensed" width="100%" width="100%">
						<thead>
						  ...
						  $query="SELECT id_mengajar FROM jadwal";
