...
// LOAD HEADER
loadAssetsHead('Data Kepala Sekolah');

//LOAD DATA
if (isset($_POST['kepala-sekolah_simpan'])) {
                      ...
                      <tbody>
                        <tr>
                          <div class="item form-group">
                           ...
                           <div class="col-md-6 col-sm-6 col-xs-12">
                           <input  type="text" id="nip" name="nip" onkeyup="convertAngkaNIP(this);" value="<?php echo $rowks['nip'];?>" required="required" class="form-control col-md-7 col-xs-12">
