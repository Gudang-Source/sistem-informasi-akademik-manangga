...
if (isset ($_POST["nilai_simpan"])) { 
    ...
    $semester     = str_replace("", "&acute;", $semester);
    ...
    $harian1     = str_replace("", "&acute;", $harian1);

    $harian2     = $_POST['harian2'];
    $harian2     = str_replace("", "&acute;", $harian2);

    $harian3     = $_POST['harian3'];
    $harian3     = str_replace("", "&acute;", $harian3);

    $tugas1     = $_POST['tugas1'];
    $tugas1     = str_replace("", "&acute;", $tugas1);

    $tugas2     = $_POST['tugas2'];
    $tugas2     = str_replace("", "&acute;", $tugas2);

    $tugas3     = $_POST['tugas3'];
    $tugas3     = str_replace("", "&acute;", $tugas3);

    $uts     = $_POST['uts'];
    $uts     = str_replace("", "&acute;", $uts);

    $uas     = $_POST['uas'];
    $uas     = str_replace("", "&acute;", $uas);
