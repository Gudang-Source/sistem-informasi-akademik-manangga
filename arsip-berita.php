...
// LOAD HEADER
loadAssetsHead('Arsip Berita Terdahulu - Sistem Informasi Akademik SDN II Manangga');
		...
		<div class="uk-grid" data-uk-grid-margin data-uk-grid-match>
			...
			<div class="uk-width-medium-5-6 tm-article-side">
				<article class="uk-article">
					...
					<h1 class="uk-article-title">Arsip Berita Terdahulu</h1>
					<br>
          <center><a href="./dashboard" class="uk-button uk-button-primary" type="button" title="Kembali ke Manajemen Guru"><i class="uk-icon-angle-left"></i> Kembali</a> </center><br>
