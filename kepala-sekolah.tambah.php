...
/*load header*/
loadAssetsHead('Tambah Master Data Kepala Sekolah');

/*form processing*/
if (isset ($_POST["kepsek_simpan"])) { 
      		...
      		<div class="uk-grid" data-uk-grid-margin data-uk-grid-match>
      			...
      			<div class="uk-width-medium-5-6 tm-article-side">
      				<article class="uk-article">
      					...
      					<h1 class="uk-article-title">Kepala Sekolah<span class="uk-text-large">{ Tambah Master Data Kepala Sekolah }</span></h1>
      					<br>
      					<a href="./kepala-sekolah" class="uk-button uk-button-primary uk-margin-bottom" type="button" title="Kembali ke Manajemen Kepala Sekolah"><i class="uk-icon-angle-left"></i> Kembali</a>
      					<!-- <hr class="uk-article-divider"> -->
      					<div class="uk-grid" data-uk-grid-margin>
      						<div class="uk-width-medium-1-1">
      							<form id="formguru" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
      								...
      								<div class="item form-group">
      									<label class="control-label col-md-3 col-sm-3 col-xs-12" for="nm_guru">Nama Kepala Sekolah<span class="required">*</span>
      									</label>
      									<div class="col-md-6 col-sm-6 col-xs-12">
...
<div class="reg-info">Wajib diisi data alamat rumah sekarang, isi data alamat rumah sekarang dengan lengkap</div>
      								...
      								<div style="text-align:center" class="form-actions no-margin-bottom">
      									<button type="submit" id="kepsek_simpan" name="kepsek_simpan" class="btn btn-success">Submit</button>
      								</div>
      							</form>    
      						</div>
      					</div>
