       ...
       <br><br>
        ...
        <div id="tablewrapper">
          ...
          <?php
            ...
            echo "<thead><tr>
            <th><h3 class='uk-text-center'>No</th>
            ...
            while($row=mysql_fetch_array($query_select)){
                ...
                <td align='center'>
                 ...
                 <a href='siswapertahun.update?id=$nis' title='Sunting' data-uk-tooltip='{pos:'top-left'}'' class='uk-button uk-button-small'>Tambah Tahun Ajaran</i></a>
                </td>
                </form>";
                echo "</form>";
                echo "</td>";
