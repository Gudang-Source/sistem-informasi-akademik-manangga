        ...
        <article class="uk-article">    
          ...
          <hr class="uk-article-divider">
            <div id="tablewrapper">
              <div id="tableheader">
              <div class="search">
               <h1 class="uk-article-title">Input Nilai Siswa <span class="uk-text-large">
                { Daftar Siswa Kelas }                 
              </span></h1></div>
              <span class="details">
                <div><span class="uk-text-large"> Mata Pelajaran </span></div>
              </span>
              </div>
              </div>
              ...
              <table id="table" class="uk-table uk-table-hover uk-table-striped uk-table-condensed" width="100%" width="100%">
                <thead>
                  <tr>
                   ...
                   <th><h3 class="uk-text-center">Input Nilai</th>                  
