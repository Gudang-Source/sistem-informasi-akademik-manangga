...
loadAssetsHead('Data Mata Pelajaran');
            ...
            $rowsl1=mysql_fetch_array($resultl1); 
            $kelase=$rowsl1['id_kelas'];
            $jenengkelase=$rowsl1['nm_kelas'];
// FORM PROCESSING
// ... code here ...
			...
			<div class="uk-width-medium-5-6 tm-article-side">
				<article class="uk-article">		
					...
					<h1 class="uk-article-title">Data Mata Pelajaran <span class="uk-text-large">
						...
						{ Data Mata Pelajaran Kelas <?php echo $jenengkelase; ?>}</span></h1>
						<?php  }?>
         <br>
          <br>
								...
								<tbody>
									...
									while ($row=mysql_fetch_array($exe)) { $no++;
										...
										<tr>
											...
											<td><div class="uk-text-left"><?php echo $row[nm_mapel]?></div></td>
