...
# SIMPAN DATA PADA FORM, Jika saat Sumbit ada yang kosong (lupa belum diisi)
  ...
  //apabila terjadi event onchange terhadap object <select readonly id=prov>
        ...
        <div class="uk-container uk-container-center uk-margin-large-top">
                              ...
                              <ul id="tabs_example2" class="uk-switcher uk-width-7-10">
                                <li>
                                 ...
                                 <div class="item form-group">
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-12">
                                     <input readonly="readonly"  type="text" id="date_tgl_lahir" name="date_tgl_lahir" value="<?php echo  date('d/m/Y', strtotime($rowks['date_tgl_lahir'] )); ?>" required="required" class="form-control col-md-7 col-xs-12" data-uk-datepicker="{format:'DD/MM/YYYY'}" >
          ...
          <li>
            <div class="uk-panel uk-panel-box">    
              ...
              <table class="uk-table uk-table-hover  uk-table-condensed"><tr><td><code class="title">Data Wali Siswa</code></td><td></td><td></td><td></td><td width="70"><li><a href="siswa.update?id=<?php echo $rowks[id_siswa]?>" ><i  class="uk-icon-pencil"></i> Edit</a></li></td> </tr></table>  
