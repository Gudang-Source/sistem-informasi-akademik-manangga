...
// LOAD HEADER
loadAssetsHead('Master Data Kriteria Kelulusan Minimal');
    ...
    <div class="uk-grid uk-margin-large-top" data-uk-grid-margin data-uk-grid-match>
      ...
      <div class="uk-width-medium-5-6 tm-article-side">
        <article class="uk-article">		
          ...
          <h1 class="uk-article-title">Data Kriteria Kelulusan Minimal <span class="uk-text-large">
						  ...
						  while ($row=mysql_fetch_array($exe)) { $no++;?>
							  ...
							  <tr>
								...
								<td width="15%"><div class="uk-text-center">
								  <a href="kkm.update?id=<?php echo $row[id_kkm]?>" title="Sunting" data-uk-tooltip="{pos:'top-left'}" class="uk-button uk-button-small"><i class="uk-icon-pencil"></i></a>
								  <a href="kkm.hapus?id=<?php echo $row[id_kkm]?>" onclick="return confirm('Apakah anda yakin akan menghapus data KKM: <?php echo $row[1] ?> ini?')" title="Hapus" data-uk-tooltip="{pos:'top-left'}" class="uk-button uk-button-small uk-button-danger"><i class="uk-icon-remove"></i></a></div>
								</td>
								<?php } ?>						
							  </tr>
							  <?php  } ?>
