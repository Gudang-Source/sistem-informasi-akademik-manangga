...
// TEMPLATE CONTROL
$ui_register_page = 'kelas.siswa.tambah';


// LOAD HEADER
loadAssetsHead('Tambah Data Siswa Ke Kelas');
    ...
    <div class="uk-grid uk-margin-large-top" data-uk-grid-margin data-uk-grid-match>
      ...
      <div class="uk-width-medium-5-6 tm-article-side">
        <article class="uk-article">		
         ...
         <form id="formkelassiswa" method="POST" class="uk-form" enctype="multipart/form-data">

         <h1 class="uk-article-title">Masukkan Siswa Ke Kelas <span class="uk-text-large">
          ...
          <div class="uk-panel uk-panel-box uk-panel-box-secondary">
           ...
           <code><label>Pilih/Checklist Siswa Yang Akan Dimasukkan Ke Kelas</label></code>
          <div id="tablewrapper">
            <div id="tableheader">
              <div class="search">
